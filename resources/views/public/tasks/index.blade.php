                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                   <th colspan="2" class="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Judul Task</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200"  id="task-list">
                                @foreach($tasks as $task)
                                        @include('public.tasks.task-row', ['task' => $task, 'level' => 0, 'childStatuses' => $childStatuses])
                                @endforeach
    ...
    <div id="comment-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg w-full max-w-2xl mx-4 p-6">
            ...
            <div class="mt-6">
             ...
             <form id="comment-form" class="mt-5" method="POST" action="" style="display:none;">
                @csrf
