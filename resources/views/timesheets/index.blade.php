                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($timesheets as $timesheet)
                                <tr>
                                    <td class="px-4 py-3 text-sm">{{ $timesheet->karyawan->nama_karyawan }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-6 text-center text-gray-500">Belum ada data timesheet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
